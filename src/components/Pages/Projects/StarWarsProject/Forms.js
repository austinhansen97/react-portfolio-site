...
// images imported but then removed
// import Tatooine from "./Tatooine.png";
// import Alderaan from "./Alderaan.png";
// import Yavin_IV from "./Yavin_IV.png";
// import Hoth from "./Hoth.png";
// import Dagobah from "./Dagobah.png";
// import Bespin from "./Bespin.gif";
// import Endor from "./Endor.png";
// import Naboo from "./Naboo.png";
// import Coruscant from "./Coruscant.png";
// import Kamino from "./Kamino.png";
...
function Forms({ planets }) {
  ...
  const findPlanetImage = (planetName) => {
    setSelectedPlanetImage(
      planetImagesArray.find((planet) => planetName === planet.name)
    );
  };
        ...
        <form className="parent-dropdowns-SW">
          ...
          <section className="right-panel-SW">
            <img
              ...
              src={selectedPlanetImage?.planetImage}
              alt={selectedPlanetImage?.name}
            />
